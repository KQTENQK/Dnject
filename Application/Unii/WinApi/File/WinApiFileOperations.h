#ifndef __UNII_WINAPIFILEOPERATIONS__
#define __UNII_WINAPIFILEOPERATIONS__
...
namespace Unii
{
    class WinApiFileOperations
    {
        public:
            ...
            static std::string OpenFileDialogPreserveDirectory
            (
                const std::string& defaultPath = "",
                const std::vector<std::pair<std::string, std::string>>& filters = {{ "All Files", "*.*" }},
                HWND parentWindow = nullptr
            ...
            static std::string SaveFileDialogPreserveDirectory
            (
                const std::string& defaultPath = "",
                const std::vector<std::pair<std::string, std::string>>& filters = {{ "All Files", "*.*" }},
                HWND parentWindow = nullptr
            ...
            static std::string SelectFolderDialogPreserveDirectory
            (
                const std::string& defaultPath = "",
                HWND parentWindow = nullptr
            )
